...
/* harmony default export */ __webpack_exports__["a"] = (Koopa);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = movement;
...
class Block extends __WEBPACK_IMPORTED_MODULE_0__entity__["a" /* default */] {
  ...
  createMushroom(data) {
    const mushroom = new __WEBPACK_IMPORTED_MODULE_3__mushroom__["a" /* default */](
      data.spriteSheet, this.xPos, this.yPos - 18, 16, 16
    );
  ...
  collectCoin(data) {
    const coin = new __WEBPACK_IMPORTED_MODULE_2__coin__["a" /* default */](
...
class Game {
  ...
  run(data) {
    const loop = () => {
      __WEBPACK_IMPORTED_MODULE_1__util_input__["a" /* input */].update(data);
      __WEBPACK_IMPORTED_MODULE_2__util_animation__["a" /* animation */].update(data);
      __WEBPACK_IMPORTED_MODULE_3__util_movement__["a" /* movement */].update(data);
      __WEBPACK_IMPORTED_MODULE_4__util_physics__["a" /* physics */].update(data);

      this.updateView(data);
      __WEBPACK_IMPORTED_MODULE_0__util_render__["a" /* render */].update(data);
